...
//AM Menu Customization
   $(".am-header, .am-container, .footer").addClass(set.theme);
...
// SETTING FOR TEXT SHADOW
   if (set.textShadow == true){
     $(".am-header *, .am-container *, .footer *").css({
...
//Light Box
 ...
 $(galleryPhoto).bind('click', function(){
   ...
   if ($(this).prop('alt') == false){
      caption = "عنوانی برای این تصویر درج نشده است";
   }
